      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => (
            <Card key={index} className="bg-gradient-glass backdrop-blur-md border border-neo-purple/20 hover:border-neo-purple/40 transition-all group hover:scale-105">
              <CardContent className="p-6">
                <div className="mb-4">
                  <div className="p-3 rounded-full bg-gradient-hero w-fit">
        ...
        {/* Benefits Section */}
        <div className="bg-gradient-card backdrop-blur-md rounded-2xl p-8 lg:p-12 border border-neo-purple/20">
